...
export const RESTORE_DESCRIPTION =
  "This action will restore the selected rows and all data linked with them.";
export const DELETE_DESCRIPTION =
  "This action will delete permanently the selected rows and all data linked with them.";
export const ARCHIVE_DESCRIPTION =
  "This action will delete the selected rows and all data linked with them.";
