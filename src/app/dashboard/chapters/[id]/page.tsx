    ...
    return (
        <div className="space-y-4">
            <div className="bg-white rounded-md shadow p-3">
                ...
                {
                    (chapter.commentaryName || chapter.commentaryText) &&
                    <div className="mt-5">
                        <h3 className="text-base font-bold pl-4">{chapter.commentaryName}</h3>
                        <QuillEditor disabled value={chapter.commentaryText ?? ""} />
                    </div>
                }
            </div>
