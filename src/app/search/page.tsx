...
export default function Page() {
  ...
  const { data: searchResult, isLoading } = useSwr<
    PaginatedApiResponse<IVerse[]>
  >(`/api/search?query=${query}`, async () => {
  ...
  return (
    <div className="w-full">
      <div className="toggle-btn bg-silver-light w-full py-3 font-inter lg:pl-3 px-3 lg:px-[10px] lg:border-0 border-b justify-between flex">
        <h3 className="text-xs font-bold text-primary-dark">Search Results for ( {query} )</h3>
      </div>
      <div className="w-full h-screen p-3 bg-primary max-h-[calc(100vh_-_201px)] lg:max-h-[calc(100vh_-_110px)] overflow-y-auto">
        <Card>
