import ForgotPasswordForm from "@/components/frontend/forms/forgot-password.form";
    ...
    <div className="overflow-hidden overflow-y-auto">
      <div className="bg-primary min-h-[calc(100vh_-_70px)] flex items-center justify-center pt-5 px-5">
        <div className="w-full max-w-lg bg-white pt-10 rounded-lg">
          ...
          <p className="mt-2 px-5 text-center text-sm text-slate-600 md:px-10">
            Enter your account email, a new password, and the site recovery key.
          </p>
